...
var iconsPath = new URL("" + new URL("icons-Cv-m8OD5.svg", import.meta.url).href, "" + import.meta.url).href;
var cls$1 = {
	giftList: "gift-list",
	giftCard: "gift-card",
...
var makeSuperpowerIcons = (points) => {
	...
	const markup = Array.from({ length: totalCount }, (_) => {
        ...
        <li class="${cls$1.giftSuperpowers}__icon">
            <svg><use href="${iconsPath}#icon-snowflake" ${--activeCount >= 0 ? activeStyle : ``}></use></svg>
        </li>
    `;
	}).join("");
