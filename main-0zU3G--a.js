import { a as msToDHMS, i as elementExpected, n as makeDetailedGiftCard, o as throttle, r as Modal, t as GiftList } from "./common-CqRB1mO6.js";
...
var Countdown = class {
	...
	static setFutureDate(...args) {
		...
		if (this.#timeLeft <= 0) console.debug("Error: The date must be in the future");
		return this;
	}
	static get timeLeft() {
